export function Welcome() {
  return (
    <section id="welcome" className="py-28 pb-32 px-4 md:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-14 inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-8 text-sm uppercase tracking-widest text-white/90  italic md:not-italic font-thin">
